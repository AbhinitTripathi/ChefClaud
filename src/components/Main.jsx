                ...
                <section>
                    ...
                    {ingredients.length >= 3 ? (
                        <div className="get-recipie-container">
                            ...
                            <button onClick={handleGetRecipie}>
                                Get Recipie
                            </button>
                        </div>
                    ) : (
                    ...
                    >
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                ground beef over medium-high heat, breaking it
                                up with a wooden spoon, until browned and cooked
                            ...
                            <li>
                                Add the crushed tomatoes, beef broth, oregano,
                                and basil. Season with salt and pepper to taste.
                            </li>
                            <li>
                                Reduce the heat to low and let the sauce simmer
                                for 15-20 minutes, stirring occasionally, to
                            ...
                            <li>
                                Add the Bolognese sauce to the cooked pasta and
                                toss to combine.
                            </li>
                            <li>
